...
GITHUB_URL = "https://https://github.com/Radu-Gabriel/CodeSinaia2026"  # placeholder
...
class App:
    ...
    def show_signup(self):
        ...
        self.signup_repeat_entry.place(x=16, y=141, width=121, height=17) #TODO: replace with actual coordinates
    ...
    def show_main(self):
        ...
        self.message_entry.place(x=154, y=512, width=519, height=33)  # TODO: replace x1, y1, x2, y2 with actual coordinates
    ...
    def _handle_send_text(self):
        ...
        encrypted = encrypt_text(message_text)
